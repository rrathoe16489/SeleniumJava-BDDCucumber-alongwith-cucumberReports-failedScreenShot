#Author: RameshRathod
Feature: Validating AssignTeam Header as a PipingRole
  ...
  Scenario Outline: Validate login
    ...
    Examples: 
      | piping        | assignTeam  |
      | piping@bv.com | Assign Team |

  Scenario Outline: Validate PipingTeamLeads Section: Select Roles and add professional name and Navigation
    ...
    Examples: 
      ...
      | Piping Team Leads | shilpa vepur / Project Engineer / Wipro | nuthalapati sravanthi / Project Engineer / Wipro | Piping Team  | nuthalapati sravanthi / Project Engineer / Wipro |

  Scenario Outline: Validate PipingTeam Section: Select Roles and add professional name and Navigation
    ...
    Examples: 
      | piping        | assignTeam  | sectionName | assigneeName                         | assigneeNameEdit                         | otherSection      | addProfessional                          |
      | piping@bv.com | Assign Team | Piping Team | Kaushikee Bhawsar / null / undefined | Nuthalapati Sravanthi / null / undefined | Piping Team Leads | Nuthalapati Sravanthi / null / undefined |
  ...
  Scenario Outline: Validate Add Project Role
    ...
    Examples: 
      ...
      | Piping Team Leads | Automation Role | Testing Automation... | Automation Role152 |
